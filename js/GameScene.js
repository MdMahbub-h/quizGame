...
class GameScene extends Phaser.Scene {
  ...
  createQuiz() {
    ...
    this.questionTitle = this.add
      .text(width / 2, 485, `QUESTION ${this.currentQuestionIndex + 1}`, {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      let letterBg = this.add.image(centerX + 7, centerY - 3, "letterBg");
      let letterText = this.add
        .text(centerX, centerY - 3, letter, {
          fontFamily: "bold",
          fontSize: "24px",
      ...
      let optionText = this.add
        .text(centerX + tempLetter.width + 15, centerY, option, {
          fontFamily: "bold",
          fontSize: "36px",
  ...
  createUi() {
    ...
    this.crossBtn = this.add.image(width * 0.08, height * 0.078, "crossBtn");
  ...
  pauseMenu() {
    ...
    this.yesBtn = this.add
      .image(width / 2, height * 0.543, "yesBtn")
      .setOrigin(0.5, 0.5)
      .setInteractive({ useHandCursor: true });
